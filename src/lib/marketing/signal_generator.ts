...
export const signalGenerator = {
     ...
     */
    generateViralScript(platform: 'Reddit' | 'TikTok' | 'Instagram' | 'Xiaohongshu' | 'Shorts', spot: any, language: string): string {
