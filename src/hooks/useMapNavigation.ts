...
import { isAutoGenerated } from '@/utils/mapUrlGenerator';
...
export const useMapNavigation = () => {
    ...
    const openMap = useCallback((spot: any, mode: MapMode = 'search') => {
        ...
        // 🔥 FIX: Use query field for search. If query is also auto-generated, use coordinate label.
        const koName = spot.query?.ko || spot.title.ko;
        const enName = language === 'ja'
