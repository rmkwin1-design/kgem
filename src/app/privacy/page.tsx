    ...
    return (
        <main className="min-h-screen bg-[var(--bg-dark)] text-[var(--text-main)] p-8 sm:p-20 font-sans">
            <div className="max-w-3xl mx-auto backdrop-blur-xl bg-[var(--card-bg)] border border-[var(--glass)] p-8 sm:p-12 rounded-[var(--radius-premium)]">
                ...
                <h1 className="text-3xl font-black mb-8 premium-gradient">{t.legal.privacy.title}</h1>

                <div className="space-y-6 text-[var(--text-muted)] leading-relaxed">
                    <section>
                        <h2 className="text-xl font-bold text-[var(--text-main)] mb-3">{t.legal.privacy.s1Title}</h2>
                    ...
                    <section>
                        <h2 className="text-xl font-bold text-[var(--text-main)] mb-3">{t.legal.privacy.s2Title}</h2>
                        <p>{t.legal.privacy.s2Desc}</p>
                    </section>

                    <section>
                        <h2 className="text-xl font-bold text-[var(--text-main)] mb-3">{t.legal.privacy.s3Title}</h2>
